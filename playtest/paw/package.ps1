...
#
#   pwsh playtest/paw/package.ps1 [-BundleNode] [-NodeVersion 22.17.0] [-Mochi C:\git\mochi]
#
...
Write-Host "Packed $zip$(if ($BundleNode) { " with node v$NodeVersion x64" }). Next: mcm packages publish mochi-playtester $zip --rid win-x64"
