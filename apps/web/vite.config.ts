...
export default defineConfig(({ mode }) => ({
  ...
  define: {
    ...
    // Online play with friends: the playtest site only, until it has been tried out (docs/pvp-plan.md).
    'import.meta.env.VITE_ONLINE': JSON.stringify(mode === 'playtest' ? 'on' : 'off'),
  },
