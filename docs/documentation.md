...
How to play, from your first game to the exact wording judges use. Start with
[The Game in 60 Seconds](rulebook.md#1-the-game-in-60-seconds), then
[Your first game in eight steps](rulebook.md#2-5-your-first-game-in-eight-steps).
...
[all your cards](collection.md#all-cards), and what makes a card rare or shiny:
[rarity](collection.md#rarity) and [Foil, Gold and Prismatic finishes](collection.md#finishes).

**[Open the Collection guide →](collection.md)**

## Wallpapers

Turn any card into a wallpaper for your phone, tablet or computer, then set it:

- [Make a wallpaper](wallpapers.md#make-a-wallpaper)
- [On iPhone or iPad, the simple way](wallpapers.md#the-simple-way)
- [On iPhone or iPad, with a Shortcut](wallpapers.md#with-a-shortcut): set up once, then two taps every time
- [On Android](wallpapers.md#android) · [On a computer](wallpapers.md#computer)

**[Open the Wallpapers guide →](wallpapers.md)**
